...
> A lightweight grocery-list web application built with HTML, CSS, and JavaScript. The implementation is stored in a dedicated project directory.
...
```bash
git clone https://github.com/DIPESH-THADA/grocery-list-website.git
cd grocery-list-website
